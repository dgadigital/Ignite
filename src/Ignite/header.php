...
<title>
	...
	<script>if (window.location.pathname === '/services/' || window.location.pathname === '/specialisations/') {window.location.replace('/');}</script>
...
<nav class="navbar navbar-main navbar-expand-lg">
  ...
  <a class="navbar-brand" href="/">
    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/nav-logo.png">
  </a>
